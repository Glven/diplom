...
import {DIALOG_PAGE, FRIEND_PAGE} from "../utils/routes/path";
        ...
        <div className="messages">
            {props.messages.map((message)=>
                <div className="messages__wrapper">
                    <NavLink key={message.id} to={DIALOG_PAGE} className="messages__item">
                        <div className="messages__photo"><img src={message.ava} alt=""/></div>
                        <div className="messages-info">
                            <p className="messages-info__author">{message.family} {message.name}</p>
